...
class ParametricLunarLanderEnv(gym.Env):
    metadata = {
    ...
    DEFAULT_DENSITY = 1.0
    DEFAULT_MAIN_ENGINE_POWER = 13.0
    DEFAULT_SIDE_ENGINE_POWER = 0.6

    def __init__(self,
                 density=DEFAULT_DENSITY,
                 main_engine_power=DEFAULT_MAIN_ENGINE_POWER,
                 side_engine_power=DEFAULT_SIDE_ENGINE_POWER):
    ...
    def reset(self):
        ...
        # print(height)
        height = [6.331644908768079, 4.246352786117449, 1.4929158779663898, 6.630241806947897,
                 0.14417906790397636, 0.9759602061773273, 1.4099241224711245, 4.5320999858471325,
                 2.0021554710776646, 5.0564947200254675, 3.9514161878048735, 2.56882930986664]
