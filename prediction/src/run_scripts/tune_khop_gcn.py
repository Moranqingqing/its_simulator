...
path_pems = '/home/bruceli/data/pems/PEMS04/PEMS04.npz'
pems_csv = '/home/bruceli/data/pems/PEMS04/PEMS04.csv'
...
param_dict = {'past_steps' : [2], 'hidden_size' : [2, 64, 128], 'batch_size': [2, 32, 128],
              'learning_rate' : [1e-3, 1e-4, 1e-5], 'weight_decay' : [1e-3, 1e-4, 1e-5],
              'horizon': [2], 'max_epoch' : [64], 'source_feature':[['flow']],
...
model.save_pytorch_model('./pems04-{}-{}-e64.pth'.format(today, str(model)) )
