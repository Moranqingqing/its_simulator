...
param_dict = {'past_steps': 2, 'hidden_size': 2, 'batch_size': 2, 'learning_rate': 0.001, 'weight_decay': 0.0001,
              'horizon': 2, 'max_epoch': 2, 'source_feature': ['flow'], 'target_feature': ['flow'], 'is_pems': True}
...
model = GCNPredictor(traffic_data, **param_dict)
