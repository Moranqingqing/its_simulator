...
lane_arrivals = []
lane_arrivals.append( ag.NormalArrivals(lane0, demand0) )
lane_arrivals.append( ag.NormalArrivals(lane1, demand1) )
lane_arrivals.append( ag.NormalArrivals(lane2, demand2) )
