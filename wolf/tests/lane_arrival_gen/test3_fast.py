...
# Override traffic lights to be red in all directions
tl_params = {
    "ALL" : {
        'name' : 'second_based',
        'params' : {
            'phases' : [ {'colors' : 'rrrr', 'min_time' : 100, 'max_time' : 100} ],
...
# === TEST 3    Five roads with the same rates, but different types
#               Traffic lights are now all red, to compare rates

demand = ag.ConstantDemand(horizon, 0.03)
