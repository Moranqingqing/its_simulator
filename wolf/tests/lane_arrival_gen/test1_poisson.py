...
lane_arrivals = []
lane_arrivals.append( ag.PoissonArrivals(lane0, demand0) )
lane_arrivals.append( ag.PoissonArrivals(lane1, demand1) )
lane_arrivals.append( ag.PoissonArrivals(lane2, demand2) )
