...
from sow45.world.environments.traffic.agents.connectors.reward.stop_time_reward_connector import StopTimeRewardConnector
...
def create_env(*_):
    ...
    for node_id in env.network.traffic_lights.get_properties().keys():
        tl = TrafficAgent(
            ...
            reward_connector=StopTimeRewardConnector(node_id=node_id, reward_space=Discrete(100), kernel=kernel),
